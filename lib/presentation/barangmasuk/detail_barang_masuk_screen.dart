...
import 'package:gudapp/presentation/barangmasuk/update_barang_masuk_screen.dart';
import 'package:gudapp/presentation/detail_gambar.dart';
import 'package:intl/intl.dart';

class DetailBarangMasukScreen extends StatelessWidget {
  final Datum barang;

  const DetailBarangMasukScreen({super.key, required this.barang});
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Gambar jika ada
                if (barang.foto != null && barang.foto.toString().isNotEmpty)
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                ...
                _buildDetailTile(
                  'Harga Beli',
                  barang.hargaBeli != null
                      ? currencyFormat.format(barang.hargaBeli!)
                      : 'Tidak diketahui',
                ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => EditBarangMasukScreen(barang: barang),
            ),
          );
        },
